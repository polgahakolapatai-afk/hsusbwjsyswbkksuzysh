        ...
        try {
            ...
            if (url.includes(cinesubzDownBase)) {
                ...
                if (check?.isUploaded === false) {
                    // New upload case
                    const urlApi = `https://manojapi.infinityapi.org/api/v1/cinesubz-download?url=${encodeURIComponent(url)}&apiKey=6f2cb8db-fa89-4f86-a060-0cec87ca6751`; 
...
let msg = `*_🩸 Title:-_* *_${sadas.data.title  || 'N/A'}_*

*_📅 Release Date:-_* _${sadas.data.date  || 'N/A'}_
*_🌎 Country:-_* _${sadas.data.country  || 'N/A'}_
*_🌟 Rating:-_* _${sadas.data.imdb  || 'N/A'}_
*_⏰ Run Time:-_* _${sadas.data.runtime  || 'N/A'}_
*_🙋 Sub By:-_* _${sadas.data.subtitle_author  || 'N/A'}_
*_🪄 Genares:-_* _${sadas.data.genres.join(', ')  || 'N/A'}_
